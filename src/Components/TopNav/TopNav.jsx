...
const TopNav = () => {
    ...
    const svg= (<svg className='w-[6.3rem] fill-white' xmlns="http://www.w3.org/2000/svg" id="yt-ringo2-svg_yt18" viewBox="0 0 93 20" focusable="false" aria-hidden="true">
  <g>
    <path d="M14.4848 20C14.4848 20 23.5695 20 25.8229 19.4C27.0917 19.06 28.0459 18.08 28.3808 16.87C29 14.65 29 9.98 29 9.98C29 9.98 29 5.34 28.3808 3.14C28.0459 1.9 27.0917 0.94 25.8229 0.61C23.5695 0 14.4848 0 14.4848 0C14.4848 0 5.42037 0 3.17711 0.61C1.9286 0.94 0.954148 1.9 0.59888 3.14C0 5.34 0 9.98 0 9.98C0 9.98 0 14.65 0.59888 16.87C0.954148 18.08 1.9286 19.06 3.17711 19.4C5.42037 20 14.4848 20 14.4848 20Z" fill="#FF0033"></path>
    <path d="M19 10L11.5 5.75V14.25L19 10Z" fill="white"></path>
  </g>
  <g id="youtube-paths_yt18">
  ...
  return (
    <>
     <div className="top_nav flex items-center justify-between p-4 fixed w-full bg-black">
        <div className="top_nav_left flex gap-5">
        <FaBars className='w-[25px] h-[20px]' />
        {svg}
        </div>
        <div className="top_nav_middle flex items-center gap-3">
            <div className="serch_wrap flex items-center gap-3 border-[1px] border-[#222222] bg-[#222222] rounded-full overflow-hidden">
            <input className='bg-[#121212] border-0 outline-none px-[17px] py-[7px] w-[34vw] ' type="text" placeholder='Search' />
        ...
        <div className="top_nav_right flex items-center justify-center gap-6">
            ...
            <CiBellOn className='text-[23px]'  />
            </div>
            <div className="account flex items-center justify-center text-[23px] bg-[#222222] w-[35px] h-[35px] rounded-full " >
                D
            </div>
        </div>
     </div>
